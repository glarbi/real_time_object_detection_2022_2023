...
train_it = datagen.flow_from_dataframe(dataframe=traindf, class_mode='binary', batch_size=64, target_size=(250, 250))
# from_directory(train_data, class_mode='binary', batch_size=64, target_size=(250, 250))
